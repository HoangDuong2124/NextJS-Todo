...
interface IProps {
    ...
    updateData: { id: string, name: string, isCheck?: boolean }
}

const ToDoItem = ({ todo, setTodo, setUpdateTodos, updateData }: IProps) => {
    ...
    return (
        <div className='w-full  grid grid-cols-5 border-b-2 '>
